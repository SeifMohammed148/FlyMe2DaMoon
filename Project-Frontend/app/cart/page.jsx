...
function Cart() {
  ...
  const getTotalAmount = () => {
		let totalAmount = 0;
		cart.forEach(item => {
			totalAmount = totalAmount + Number(item?.product?.attributes?.productprice)
		})
		return totalAmount
	}
			...
			<div className="max-w-screen-xl px-4 py-8 mx-auto sm:px-6 sm:py-12 lg:px-8">
				<div className="max-w-3xl mx-auto">
					<header className="text-center">
						<h1 className="text-xl font-bold text-gray-900 sm:text-3xl">Your Future Trips </h1>
					</header>
								...
								<li className="flex items-center gap-4">
									...
									<div>
										...
										<dl className="mt-0.5 space-y-px text-[10px] text-gray-600">
											<div>
												<dt className="inline">Continent : </dt>
									...
									<div className="flex items-center justify-end flex-1 gap-2">
										${item?.product?.attributes?.productprice}
